...
public class EthMnemonic {
	...
	public static void main(String[] args) {
		//生成助记词
//		EthHDWallet wallet=generateMnemonic(ETH_TYPE, "11111111");
//
//		System.out.println("钱包信息:  钱包地址："+wallet.Address+"    钱包公钥"+wallet.publicKey+"   钱包私钥："+wallet.privateKey+"   keystore"+wallet.keystore+"   mnemonicPath"+wallet.mnemonicPath);
//		System.out.println(wallet.mnemonic.size()+"   "+wallet.mnemonic.get(0));

		//导入助记词
		//[better peace sniff void pool phrase retreat stumble combine onion monitor weekend]
		...
		list.add("monitor");
		list.add("weekend");
		importMnemonic(ETH_TYPE, list, "tian550345681");
	}
